...
@st.cache_data
def create_linguistic_graph(edited_matrix, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize,):
    fig = st.pyplot(create_visual_map_linguistic(edited_matrix, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize), clear_figure=False)
...
def graph(edited_matrix, linguistic = False):
    ...
    with col2:
        ...
        if linguistic:
            fig = create_linguistic_graph(edited_matrix, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize)
        else:
