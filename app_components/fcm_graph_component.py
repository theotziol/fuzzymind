...
#@st.cache_data
def create_graph(edited_matrix, layout_func, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize,):
    fig = st.pyplot(create_visual_map(edited_matrix, layout_func, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize), clear_figure=False)

#@st.cache_data
def create_linguistic_graph(edited_matrix, layout_func, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize,):
    fig = st.pyplot(create_visual_map_linguistic(edited_matrix, layout_func, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize), clear_figure=False)
...
def graph(edited_matrix, linguistic = False):
    ...
    with col2:
        ...
        if linguistic:
            fig = create_linguistic_graph(edited_matrix, layout_func, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize)
        else:
            fig = create_graph(edited_matrix, layout_func, figsize, nodesize, font_size, weights_font_size, title_font_size, arrowsize)
...
def create_visual_map(
    ...
    pos = layout_func(G)  # Define layout. Alternative: https://networkx.org/documentation/stable/reference/generated/networkx.drawing.layout.spring_layout.html
    M = G.number_of_edges()
